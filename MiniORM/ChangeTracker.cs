...
namespace MiniORM
{
        ...
        where T : class, new()
    {
        ...
        public IEnumerable<T> GetModifiedEntities(DbSet<T> dbSet)
        {
            ...
            {
                var primaryKeyValues = GetPrimaryKeysValues(primaryKeys, proxyEntity).ToArray();


                var entity = dbSet.Entities.Single(e => GetPrimaryKeysValues(primaryKeys, e).SequenceEqual(primaryKeyValues));
